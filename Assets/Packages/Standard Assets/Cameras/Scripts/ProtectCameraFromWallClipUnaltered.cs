// CUSTOM CHANGES IN PROTECTCAMERAFROMWALLCLIPUNALTERED
// LOOK FOR ARROWS
// <--------------- 
...
{
    public class ProtectCameraFromWallClipUnaltered : MonoBehaviour
    {
        ...
        //CHANGE --Sean
        //
        public string[] dontClipTags = new string[] { "Player", "Equipment", "Enemy" };
